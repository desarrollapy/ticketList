...
class RegistrarUserForm(forms.Form):
    ...
    againPassword = forms.CharField(widget=forms.PasswordInput(),error_messages={'required':'Ingrese un password valido'}, required=False)
    ...
    codigo = forms.CharField(max_length=100, error_messages={'required': 'Debe ingresar un Codigo para su perfil'},
                               required=True)
